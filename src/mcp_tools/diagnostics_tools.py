...
def register(mcp: FastMCP) -> None:
    ...
    mcp.tool()(check_bearing_fault_peak_tool)
    mcp.tool()(check_bearing_faults_direct)
    mcp.tool()(lookup_bearing_and_compute_tool)
    mcp.tool()(assess_vibration_severity)
